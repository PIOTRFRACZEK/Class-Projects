...
# present statment
        print("Choose only one answere a, b or c:"+color.BOLD+"\nQ"+ str(questionNumber)+ "."+color.END + single_statement[0])
...
# check if guess is correct
        if guess== single_statement[1]:
            print(color.GREEN+" # “Congrats "+playerName+". You got 10 points!!!“ # \n"+color.END)
# update score
            score=score+10
        else:
            print(color.RED+" # “Aww, what a shame. That wasn’t the correct answer. You got 0 points.“ # \n"+color.END)
        
#final score
    maxPoints=str(10*number_of_questions)
    print(playerName + color.BOLD + color.BLUE + " your final score is: " + color.END + str(score)+" / "+str(maxPoints))
...
# lost a game
    if number_of_questions==5 and score>=40:
        print(color.BOLD+color.YELLOW+"******************************************************************"+color.END)
        print(color.BOLD+color.BLUE+"“Bravo, bravo "+playerName+"! You’ve won the round!” "+color.END)
        print(color.BOLD+color.YELLOW+"******************************************************************"+color.END)
    elif number_of_questions==3 and score>=20:
        print(color.BOLD+color.YELLOW+"******************************************************************"+color.END)
        print(color.BOLD+color.BLUE+"“Bravo, bravo "+playerName+"! You’ve won the round!” ")
        print(color.BOLD+color.YELLOW+"******************************************************************"+color.END)
    else:
        print(color.BOLD+color.PURPLE+"******************************************************************"+color.END)
        print(color.BOLD+color.BLUE+"“Oh dear. So close and yet so far. Good luck next time "+playerName+"!” ")
        print(color.BOLD+color.PURPLE+"******************************************************************"+color.END)
